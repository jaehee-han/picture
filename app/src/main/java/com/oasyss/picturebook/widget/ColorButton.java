...
public class ColorButton extends ColoringButton
{
    ...
    public static final int INSET_HIGHLIGHT_PERCENT = 0;
...
//        final int w = getWidth();
        ...
        else
        {
            if (_selected)
            {
                ...
                _colorDrawable.setStroke(10, Color.parseColor("#f93838"));

            }
            else
            {
                p = minwh * PADDING_NORMAL_PERCENT / 100;
                _colorDrawable.setStroke(10, Color.parseColor("#000000"));
            }
        }
