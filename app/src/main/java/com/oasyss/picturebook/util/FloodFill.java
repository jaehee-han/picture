...
import com.oasyss.picturebook.util.quell.BlackAndWhiteConversion;
...
public class FloodFill extends BitmapConverter {
	...
	private final com.oasyss.picturebook.util.quell.FloodFill floodFill;

	public FloodFill(Bitmap bitmap, int color) {
		super(bitmap);
		this.color = color;
		floodFill = new com.oasyss.picturebook.util.quell.FloodFill(getPixelsOfBitmap(), getWidth(), getHeight(), BORDER_COLOR);
	}
